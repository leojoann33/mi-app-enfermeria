const e=[{id:"farm_metamizol",nameES:"Metamizol (Nolotil®)",nameRO:"Metamizol (Nolotil®)",categoryES:"Analgésico / Antipirético",categoryRO:"Analgezic / Antipiretic",descES:"Analgésico, antipirético y espasmolítico. Uno de los más usados en España. El más eficaz antipirético inyectable.",descRO:"Analgezic, antipiretic și spasmolitic. Unul dintre cele mai utilizate în Spania. Cel mai eficient antipiretic injectabil.",contentES:`
...
> *"Agranulocitoză: febră + gât — Dacă un pacient care ia de zile întregi metamizol are febră și durere în gât, suspectați și anunțați."*
    `},{id:"farm_insulina_rapida",nameES:"Insulina Rápida (Actrapid®)",nameRO:"Insulină Rapidă (Actrapid®)",categoryES:"Insulina Humana Regular",categoryRO:"Insulină Umană Regulată",descES:"Insulina cristalina transparente de acción corta. La ÚNICA que se puede administrar por vía IV. Para correcciones de glucemia y cetoacidosis.",descRO:"Insulină cristalină transparentă cu acțiune scurtă. SINGURA care poate fi administrată IV. Pentru corecții glicemice și cetoacidoză.",contentES:`
## ¿Qué es y para qué se usa?
...
> *"Frigider, nu congelator — Insulina Se păstrează la frigider (2-8°C). Dacă îngheață, se strică."*
    `},{id:"farm_furosemida",nameES:"Furosemida (Seguril®)",nameRO:"Furosemidă (Seguril®)",categoryES:"Diurético de Asa",categoryRO:"Diuretic de Ansă",descES:"Diurético potente de techo alto. Fundamental en Edema Agudo de Pulmón e Insuficiencia Cardíaca. Velocidad IV muy importante.",descRO:"Diuretic puternic. Fundamental în Edem Pulmonar Acut și Insuficiență Cardiacă. Viteza IV este foarte importantă.",contentES:`
## ¿Qué es y para qué se usa?
...
> *"IV lentă = mai puține probleme — 80 mg în 20 minute, nu în 2."*
    `},{id:"farm_paracetamol_iv",nameES:"Paracetamol IV (Perfalgan®)",nameRO:"Paracetamol IV (Perfalgan®)",categoryES:"Analgésico / Antipirético",categoryRO:"Analgezic / Antipiretic",descES:"Analgésico y antipirético de primera línea. La presentación IV se usa cuando el paciente no puede tomar oral. Viene listo para usar.",descRO:"Analgezic și antipiretic de primă linie. Prezentarea IV se folosește când pacientul nu poate lua oral. Vine gata de utilizare.",contentES:`
## ¿Qué es y para qué se usa?
...
> *"Nu este antiinflamator — Pentru inflamație, va fi nevoie de AINS."*
    `},{id:"farm_omeprazol_iv",nameES:"Omeprazol IV (Losec®)",nameRO:"Omeprazol IV (Losec®)",categoryES:"Inhibidor Bomba de Protones (IBP)",categoryRO:"Inhibitor Pompă de Protoni (IPP)",descES:"Reduce la producción de ácido gástrico. En hemorragia digestiva: bolo 80 mg + perfusión 8 mg/h. Proteger de la luz.",descRO:"Reduce producția de acid gastric. În hemoragie digestivă: bolus 80 mg + perfuzie 8 mg/h. Protejați de lumină.",contentES:`
## ¿Qué es y para qué se usa?
...
> *"Nu este pentru durere — Protejează, dar nu ameliorează simptomele acute."*
    `},{id:"farm_ondansetron",nameES:"Ondansetrón (Zofran®)",nameRO:"Ondansetron (Zofran®)",categoryES:"Antiemético",categoryRO:"Antiemetic",descES:"Antiemético muy eficaz. Antagonista 5-HT3. Usado en náuseas postoperatorias, quimioterapia y gastroenteritis. Precaución con QT largo.",descRO:"Antiemetic foarte eficient. Antagonist 5-HT3. Folosit în greață postoperatorie, chimioterapie și gastroenterită. Precauție cu QT lung.",contentES:`
## ¿Qué es y para qué se usa?
